...
REM Start email-service (Port 8085)
start "Email Service (8085)" cmd /k "cd email-service && ..\mvnw.cmd spring-boot:run"
timeout /t 3 /nobreak >nul
...
echo   - Email Service          : http://localhost:8085/swagger-ui.html
